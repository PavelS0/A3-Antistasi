...
_targets = nearestObjects [getposATL _container, ["Man"], LTCRadius];
_weaponHolders = nearestObjects [getposATL _container, ["WeaponHolder","WeaponHolderSimulated"], LTCRadius];
